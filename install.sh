...
apt update
apt install -y mysql-server libmysqlclient-dev git-core subversion imagemagick libmagickwand-dev libcurl4-openssl-dev ruby-full dirmngr gnupg
...
curl -O https://raw.githubusercontent.com/AlPervakov/Redmine/master/database.yml
